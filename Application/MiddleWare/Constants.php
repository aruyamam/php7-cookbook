...
class Constants
{
   ...
   const CONTENT_TYPE_JSON = 'applicatoin/json';
   const CONTENT_TYPE_HAL_JSON = 'applicatoin/hal+json';
   ...
   const ERROR_INVALID_UPLOADED = 'ERROR: must supply an array of UploadedFileInterface instance';
